...
<head>
    ...
    <title>Airline Diandji | Votre meilleur site de Réservation de Billet d'Avion</title>
    <!-- CSS only -->
...
<body>
	...
	<main class="main">
	    ...
	    <section>
	    	...
	    	<div class="desti">
	    		<h4 class="sub-title"><i class="fa-solid fa-plane" aria-hidden="true"></i> &nbsp; Vols</h4>
	    		<div class="checkbox">
